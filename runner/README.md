...
```
socket.emit('runner-send-chatting', {
    "from": integer,
    "from_type": integer|3=runner,2=admin,
    "to": integer,
    "to_type": integer|3=runner,2=admin,
...
**URL** : `/api/runner/last-chat-contact`
...
```
socket.emit('runner-mark-as-read', {
    id: integer,
    to: integer,
    to_type: integer|3=runner,2=admin
});
